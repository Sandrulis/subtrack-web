...
**Versija:** `0.3.43` (skatīt lapas lejas daļā **[Izmaiņu žurnāls](#izmaiņu-žurnāls)**).
...
- **Kalendārs** – ja **nav abonementu**, notīra **`subtrack_cal_paid_marked_v1`** un nerāda „samaksāts” atzīmes bez ierakstiem (**`dashboard.js`**, **`subscriptions-helpers.js`**).
